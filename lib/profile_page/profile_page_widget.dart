...
import '../components/no_post_widget.dart';
import '../components/noplans_widget.dart';
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.network(
                                          valueOrDefault<String>(
                                            ...
                                            'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/socializer-jd5b3t/assets/2b1nrc0eprj7/62-622164_client-image-user-icon-png.png',
                                          ),
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                          ...
                          child: TabBarView(
                            children: [
                              Container(
                                ...
                                child: StreamBuilder<List<PlanRecord>>(
                                  stream: queryPlanRecord(
                                    queryBuilder: (planRecord) =>
                                        planRecord.where('specifications',
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<PlanRecord> listViewPlanRecordList =
                                        snapshot.data!;
                                    if (listViewPlanRecordList.isEmpty) {
                                      return Center(
                                        child: NoplansWidget(),
                                      );
                                    }
