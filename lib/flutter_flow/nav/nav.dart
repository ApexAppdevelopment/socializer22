...
class AppStateNotifier extends ChangeNotifier {
  DavaoprimeappFirebaseUser? initialUser;
  DavaoprimeappFirebaseUser? user;
  ...
  void update(DavaoprimeappFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'plandetails',
              asyncParams: {
                'plan': getDoc(['Plan'], PlanRecord.serializer),
              },
              builder: (context, params) => PlandetailsWidget(
                plan: params.getParam('plan', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'checkout',
              ...
              asyncParams: {
                'plan': getDoc(['Plan'], PlanRecord.serializer),
                'price': getDoc(['Plan'], PlanRecord.serializer),
              },
            ...
            FFRoute(
              ...
              path: 'gcash1K',
              asyncParams: {
                'planprice': getDoc(['Plan'], PlanRecord.serializer),
              },
              builder: (context, params) => Gcash1KWidget(
                planprice: params.getParam('planprice', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'Postpage',
              path: 'postpage',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Postpage')
                  : PostpageWidget(),
            ),
            FFRoute(
              name: 'profilePage',
            ...
            FFRoute(
              ...
              path: 'plans',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'plans')
                  : PlansWidget(),
            ),
            FFRoute(
              name: 'commission',
              path: 'commission',
              builder: (context, params) => CommissionWidget(),
            ),
            FFRoute(
              name: 'Productslist',
              path: 'productslist',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Productslist')
                  : ProductslistWidget(),
            ),
            FFRoute(
              ...
              asyncParams: {
                'order': getDoc(['products'], ProductsRecord.serializer),
              },
              builder: (context, params) => ProductCheckOutWidget(
            ...
            FFRoute(
              ...
              builder: (context, params) => Gcash1KCopyWidget(
                order: params.getParam('order', ParamType.Document),
              ),
            ),
            FFRoute(
              ...
              path: 'downlines',
              asyncParams: {
                'createduser': getDoc(['users'], UsersRecord.serializer),
              },
              builder: (context, params) => DownlinesWidget(
                createduser: params.getParam('createduser', ParamType.Document),
              ),
            )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Macro_Plex_4K_Motion_Background_Loop_(1).gif',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
